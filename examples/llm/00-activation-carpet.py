...
"""00 - Raw hidden-state coordinates from a Hugging Face model, written from CUDA into an OSG VBO."""
...
def build_scene(w, h):
	...
	args = causal_lm_arguments("00 - render raw hidden states through CUDA/GL interop")
	...
	configure_glowing_points(geode, "Activation Carpet", VERTEX_SHADER)
