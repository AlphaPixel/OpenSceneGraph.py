...
#define PYOSG_DISABLE_WARNINGS                                                 \
  _Pragma("clang diagnostic push")                                             \
      _Pragma("clang diagnostic ignored \"-Wconversion\"") _Pragma(            \
          "clang diagnostic ignored \"-Wsign-conversion\"")                    \
          _Pragma("clang diagnostic ignored \"-Wdeprecated-copy\"") _Pragma(   \
              "clang diagnostic ignored \"-Wfloat-conversion\"")               \
...
#define PYOSG_ENABLE_WARNINGS _Pragma("clang diagnostic pop")
...
public:
  ...
  static void init() {
    PyImport_AppendInittab(OPENSCENEGRAPH_PYTHON_MODULE,
                           &PyInit_openscenegraph);
  }
